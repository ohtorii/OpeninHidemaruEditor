...
namespace OpeninHidemaruEditor
{
    ...
    internal sealed class OpeninHidemaruEditorCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("610d7b6f-5697-40cd-b3c4-a1dca9011d91");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            string message = string.Format(CultureInfo.CurrentCulture, "Inside {0}.MenuItemCallback()\nPath={1}", this.GetType().FullName, _settings.FolderPath);
            string title = "OpeninHidemaruEditorCommand";
